...
function PitchLines() {
  return (
    <>
      <div className="absolute inset-[5%] border border-white/48" />
      <div className="absolute bottom-[5%] left-1/2 top-[5%] w-px bg-white/30" />
      <div className="absolute left-1/2 top-1/2 size-20 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/30" />
      <div className="absolute left-[5%] top-1/2 h-[36%] w-[13%] -translate-y-1/2 border border-l-0 border-white/36" />
      <div className="absolute right-[5%] top-1/2 h-[36%] w-[13%] -translate-y-1/2 border border-r-0 border-white/36" />
      <div className="absolute left-[5%] top-1/2 h-[18%] w-[6%] -translate-y-1/2 border border-l-0 border-white/36" />
      <div className="absolute right-[5%] top-1/2 h-[18%] w-[6%] -translate-y-1/2 border border-r-0 border-white/36" />
      <div className="absolute left-[16.5%] top-1/2 size-1 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/55" />
      <div className="absolute right-[16.5%] top-1/2 size-1 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/55" />
      <div className="absolute left-[3.8%] top-1/2 h-[13%] w-1 -translate-y-1/2 bg-white/65" />
      <div className="absolute right-[3.8%] top-1/2 h-[13%] w-1 -translate-y-1/2 bg-white/65" />
    </>
  )
}
...
export function FieldPitch({
  ...
  return (
    <motion.div
      className="relative aspect-[105/68] min-h-[320px] overflow-hidden rounded-[26px] bg-[linear-gradient(90deg,rgba(22,80,42,0.32),rgba(13,45,27,0.26),rgba(22,80,42,0.32))]"
